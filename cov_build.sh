...
############################
# Build entservices-devicediagnostics
echo "buliding entservices-devicediagnostics"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-devicediagnostics \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-devicediagnostics --target install
echo "======================================================================================"
exit 0
