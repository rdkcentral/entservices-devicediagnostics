...
|---|---|---|---|
| Code to Spec Coverage | 40% | 99.1% | **39.7** |
...
| Conformance Testing & Validation | 10% | 80% | **8.0** |
| **TOTAL** | **100%** | | **88.7 / 100** |

---

## 1. Code to Spec Coverage — 39.7 / 40
...
|---|---|---|---|
| `IDeviceDiagnostics.h` | 12 | 12 | 0 |
| `plugin/DeviceDiagnostics.h` | 5 | 4 | 1 |
| `plugin/DeviceDiagnostics.cpp` | 6 | 6 | 0 |
| `plugin/DeviceDiagnosticsImplementation.h` | 3 | 3 | 0 |
...
| `Tests/L1Tests/tests/test_DeviceDiagnostics.cpp` | 4 fixtures | 4 | 0 |
| `Tests/L2Tests/tests/DeviceDiagnostics_L2Test.cpp` | 4 helpers | 4 | 0 |
| **TOTAL** | **49** | **48** | **1** |
...
**`Tests/L1Tests/tests/test_DeviceDiagnostics.cpp` (4):**
...
**`Tests/L2Tests/tests/DeviceDiagnostics_L2Test.cpp` (4):**
...
|---|---|---|---|
| Reference Coverage | 20% | 48/49 = 98.0% × 20 | **19.6** |
| Spec Existence | 10% | 1/1 = 100% × 10 | **10.0** |
| Spec Completeness | 5% | 1/1 = 100% × 5 | **5.0** |
| No Orphaned Code | 5% | 48/49 = 98.0% × 5 | **4.9** |
| **Subtotal** | **40%** | | **39.5 / 40** |
...
| Sub-criterion | Weight | Score | Evidence / Gap |
|---|---|---|---|
| Presence of Conformance Tests | 3% | **3/3** | L1 tests: 4 fixtures (was 1); L2 tests: 11 + 2 new `GetPreviousRebootInfo` cases |
| Test Coverage | 3% | **3/3** | All 5 JSON-RPC methods now have L1 and L2 coverage; `getPreviousRebootInfo` has 3 L1 + 2 L2 cases |
...
| G-12 | Medium | Conformance | ~~L1 tests missing for `getMilestones` and `logMilestone`~~ | ~~Resolved: L1 tests missing note superseded — `getPreviousRebootInfo` L1 tests added~~ |
...
- [2026-04-27] - openspec-coverage - Rev 3: Rescored after `add-get-previous-reboot-info` apply run. Added `GetPreviousRebootInfo` to `IDeviceDiagnostics.h` (1 new), `DeviceDiagnosticsImplementation.h` (1 new), `DeviceDiagnosticsImplementation.cpp` (1 new), 3 L1 test cases, 2 L2 test cases. Total symbols 42→49, covered 41→48. Score updated from 87.9 → 88.7.
